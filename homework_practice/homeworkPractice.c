...
// Function Prototype - "Here is the code that will be used later on"
...
int main(void) {
    ...
    // Function Call - Runs/Uses the Function, "Use the Function now!"/"Do your job now!"
    result = checkInput(first_integer, second_integer);

    // Required Result - What will be the output/ printed end results
    if (result == 1) {
        printf("1\n");
    }
    else if (result == 2) {
...
// Function Defenition - Manual for Function; Calculations and Logical Operators Here
int checkInput(int first_integer, int second_integer) {
